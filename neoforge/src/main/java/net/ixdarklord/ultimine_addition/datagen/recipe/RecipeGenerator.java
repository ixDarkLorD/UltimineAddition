...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        ItemStorageDataRecipeBuilder.create(RecipeCategory.MISC, Registration.PEN.get())
                ...
                .save(output.withConditions(new LegacyModeCondition(false)), UltimineAddition.getLocation("refill"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Registration.MINER_CERTIFICATE.get())
                ...
                .save(output.withConditions(new LegacyModeCondition(true)), UltimineAddition.getLocation("miner_certificate_legacy"));
    }
}
