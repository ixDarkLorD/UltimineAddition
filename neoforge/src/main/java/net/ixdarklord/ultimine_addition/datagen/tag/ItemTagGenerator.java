...
public class ItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        this.tag(ModItemTags.LEGACY_DISABLED_ITEMS)
                .add(ModItems.SKILLS_RECORD, ModItems.PEN, ModItems.INK_CHAMBER)
                .addTag(ModItemTags.MINING_SKILL_CARD);

        this.tag(ModItemTags.MINING_SKILL_CARD)
                .add(ModItems.MINING_SKILL_CARD_EMPTY, ModItems.MINING_SKILL_CARD_PICKAXE, ModItems.MINING_SKILL_CARD_AXE, ModItems.MINING_SKILL_CARD_SHOVEL, ModItems.MINING_SKILL_CARD_HOE);
        ...
        this.tag(ModItemTags.LESS_VALUABLE_PIGMENT)
                .add(Items.WHITE_DYE, Items.BROWN_DYE, Items.CYAN_DYE, Items.GRAY_DYE, Items.LIGHT_BLUE_DYE, Items.LIGHT_GRAY_DYE, Items.LIME_DYE, Items.MAGENTA_DYE, Items.ORANGE_DYE, Items.PINK_DYE, Items.PURPLE_DYE, Items.YELLOW_DYE).addOptionalTags(Tags.Items.DYES_WHITE, Tags.Items.DYES_BROWN, Tags.Items.DYES_CYAN, Tags.Items.DYES_GRAY, Tags.Items.DYES_LIGHT_BLUE, Tags.Items.DYES_LIGHT_GRAY, Tags.Items.DYES_LIME, Tags.Items.DYES_MAGENTA, Tags.Items.DYES_ORANGE, Tags.Items.DYES_PINK, Tags.Items.DYES_PURPLE, Tags.Items.DYES_YELLOW);
    }
}
