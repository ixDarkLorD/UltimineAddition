...
public class MineGoJuiceRecipe extends BrewingRecipe {
    ...
    private static void addTiers(@NotNull Item item, ResourceLocation output) {
        ...
        Potion potion1 = ForgeRegistries.POTIONS.getValue(output);
        ...
        Potion potion2 = ForgeRegistries.POTIONS.getValue(new ResourceLocation(output + "_2"));
        ...
        Potion potion3 = ForgeRegistries.POTIONS.getValue(new ResourceLocation(output + "_3"));
