...
public class ItemModelGenerator extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        simpleItem(ModItems.MINER_CERTIFICATE)
                .override()
                .predicate(FTBUltimineAddition.id("opened"), 1.0f)
        ...
        simpleItem(ModItems.MINING_SKILL_CARD_PICKAXE, "_unlearned")
                .override()
                .predicate(FTBUltimineAddition.id("is_custom_renderer"), 1.0f)
                .model(FTBUltimineAddition.id("item/custom_renderer/mining_skill_card"))
                .end()
                .override()
                .predicate(FTBUltimineAddition.id("tier_1"), 1.0f)
                .model(getItemModelName(ModItems.MINING_SKILL_CARD_PICKAXE, "_1"))
                .end()
                .override()
                .predicate(FTBUltimineAddition.id("tier_2"), 1.0f)
                .model(getItemModelName(ModItems.MINING_SKILL_CARD_PICKAXE, "_2"))
                .end()
                .override()
                .predicate(FTBUltimineAddition.id("tier_3"), 1.0f)
                .model(getItemModelName(ModItems.MINING_SKILL_CARD_PICKAXE, "_3"))
                .end()
                .override()
                .predicate(FTBUltimineAddition.id("tier_maxed"), 1.0f)
        ...
        specialRendererItem(FTBUltimineAddition.id("custom_renderer/mining_skill_card")).guiLight(BlockModel.GuiLight.FRONT);
        simpleItem(FTBUltimineAddition.id("custom_renderer/mining_skill_card"), "_unlearned").addStringToFileName();
        simpleItem(FTBUltimineAddition.id("custom_renderer/mining_skill_card"), "_1").addStringToFileName();
        simpleItem(FTBUltimineAddition.id("custom_renderer/mining_skill_card"), "_2").addStringToFileName();
        simpleItem(FTBUltimineAddition.id("custom_renderer/mining_skill_card"), "_3").addStringToFileName();
        simpleItem(FTBUltimineAddition.id("custom_renderer/mining_skill_card"), "_mastered").addStringToFileName();
    }

    private ResourceLocation getItemModelName(Item item, String suffix) {
        return FTBUltimineAddition.id("item/" + Objects.requireNonNull(Registration.ITEMS.getRegistrar().getId(item)).getPath() + suffix);
    }
}
