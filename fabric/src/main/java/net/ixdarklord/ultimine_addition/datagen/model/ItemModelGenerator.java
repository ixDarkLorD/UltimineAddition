...
public class ItemModelGenerator extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        simpleItem(ModItems.MINING_SKILL_CARD_PICKAXE, "_unlearned")
                ...
                .model(FTBUltimineAddition.getLocation("item/custom_renderer/mining_skill_card"))
                .end()
                .override()
        ...
        specialRendererItem(FTBUltimineAddition.getLocation("custom_renderer/mining_skill_card")).guiLight(BlockModel.GuiLight.FRONT);
        simpleItem(FTBUltimineAddition.getLocation("custom_renderer/mining_skill_card"), "_unlearned").addStringToFileName();
        simpleItem(FTBUltimineAddition.getLocation("custom_renderer/mining_skill_card"), "_1").addStringToFileName();
        simpleItem(FTBUltimineAddition.getLocation("custom_renderer/mining_skill_card"), "_2").addStringToFileName();
        simpleItem(FTBUltimineAddition.getLocation("custom_renderer/mining_skill_card"), "_3").addStringToFileName();
        simpleItem(FTBUltimineAddition.getLocation("custom_renderer/mining_skill_card"), "_mastered").addStringToFileName();
    }

    private ResourceLocation getItemModelName(Item item, String suffix) {
        return FTBUltimineAddition.getLocation("item/" + Objects.requireNonNull(Registration.ITEMS.getRegistrar().getId(item)).getPath() + suffix);
    }
}
