...
public record LegacyModeCondition(boolean value) implements ResourceCondition {
    ...
    public static final ResourceConditionType<LegacyModeCondition> RESOURCE_CONDITION_TYPE = ResourceConditionType.create(FTBUltimineAddition.rl("legacy_mode"), CODEC);
