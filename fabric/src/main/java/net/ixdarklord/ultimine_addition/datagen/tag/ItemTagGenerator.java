...
public class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
   ...
   protected void addTags(HolderLookup.Provider provider) {
      ...
      this.getOrCreateTagBuilder(ModItemTags.LEGACY_DISABLED_ITEMS).add(ModItems.SKILLS_RECORD, ModItems.PEN, ModItems.INK_CHAMBER).addTag(ModItemTags.MINING_SKILL_CARD);
