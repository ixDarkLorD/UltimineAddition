...
public class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        this.getOrCreateTagBuilder(PlatformTags.get().SLIME())
                .add(Items.SLIME_BALL);

        this.getOrCreateTagBuilder(ModItemTags.LEGACY_DISABLED_ITEMS)
                .add(ModItems.SKILLS_RECORD, ModItems.PEN, ModItems.INK_CHAMBER)
                .addTag(ModItemTags.MINING_SKILL_CARD);

        this.getOrCreateTagBuilder(ModItemTags.MINING_SKILL_CARD)
        ...
        this.getOrCreateTagBuilder(ModItemTags.MORE_VALUABLE_PIGMENT)
        ...
        this.getOrCreateTagBuilder(ModItemTags.LESS_VALUABLE_PIGMENT)
