...
public class ConfigLifecycleEvent {
    public static final Event<ConfigUpdate> EVENT = EventFactory.createLoop(new ConfigUpdate[0]);
    ...
    public interface ConfigUpdate {
        void onConfigUpdate(ConfigInfo configInfo, ConfigUpdateType configUpdateType);
    }
}
