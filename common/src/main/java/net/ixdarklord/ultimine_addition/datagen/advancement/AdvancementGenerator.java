...
public class AdvancementGenerator extends AdvancementProvider {
    ...
    protected void registerAdvancements(@NotNull Consumer<Advancement> consumer) {
        Advancement root = Advancement.Builder.advancement().display(
                        ...
                        new TranslatableComponent(String.format("itemGroup.%s.tab", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.root.desc", UltimineAddition.MOD_ID)),
        ...
        Advancement amethyst = Advancement.Builder.advancement().parent(root).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.amethyst_gathering", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.obtain", UltimineAddition.MOD_ID), Items.AMETHYST_SHARD.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement cardBlueprint = Advancement.Builder.advancement().parent(amethyst).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.craft.card.blueprint", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.CARD_BLUEPRINT.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement slime = Advancement.Builder.advancement().parent(root).display(
                        Items.SLIME_BALL,
                        new TranslatableComponent(String.format("advancement.%s.obtain.slime_balls", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.obtain", UltimineAddition.MOD_ID), Items.SLIME_BALL.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement pen = Advancement.Builder.advancement().parent(slime).display(
                        ModItems.PEN,
                        new TranslatableComponent(String.format("advancement.%s.craft.pen", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.PEN.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement emptyCard = Advancement.Builder.advancement().parent(root).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.obtain.card.empty", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.obtain", UltimineAddition.MOD_ID), ModItems.MINING_SKILL_CARD_EMPTY.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement skillsRecord = Advancement.Builder.advancement().parent(emptyCard).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.craft.skills_record", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.SKILLS_RECORD.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.GOAL,
                        true, true, false)
        ...
        Advancement pickaxeCard = Advancement.Builder.advancement().parent(emptyCard).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.craft.card.pickaxe", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.MINING_SKILL_CARD_PICKAXE.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement axeCard = Advancement.Builder.advancement().parent(emptyCard).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.craft.card.axe", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.MINING_SKILL_CARD_AXE.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement shovelCard = Advancement.Builder.advancement().parent(emptyCard).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.craft.card.shovel", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.MINING_SKILL_CARD_SHOVEL.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement hoeCard = Advancement.Builder.advancement().parent(emptyCard).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.craft.card.hoe", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.craft", UltimineAddition.MOD_ID), ModItems.MINING_SKILL_CARD_HOE.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.TASK,
                        true, true, false)
        ...
        Advancement ultiminePower = Advancement.Builder.advancement().parent(skillsRecord).display(
                        ...
                        new TranslatableComponent(String.format("advancement.%s.ultimine_ability", UltimineAddition.MOD_ID)),
                        new TranslatableComponent(String.format("advancement.%s.ultimine_ability.desc", UltimineAddition.MOD_ID), ModItems.MINER_CERTIFICATE.getDefaultInstance().getHoverName()),
                        null,
                        FrameType.CHALLENGE,
                        true, true, false)
