...
public class KeyHandler {
    ...
    public static KeyMapping KEY_SHOW_PROGRESSION_BAR = create(FTBUltimineAddition.rl("show_progression_bar"), InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_LEFT_ALT, KEY_CATEGORY);
    public static KeyMapping KEY_OPEN_SKILLS_RECORD = create(FTBUltimineAddition.rl("open_skills_record"), InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_R, KEY_CATEGORY);
